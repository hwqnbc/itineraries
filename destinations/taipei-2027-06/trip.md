---
title: Taipei, Taiwan
short: Taipei June 2027
flag: 🇹🇼
status: planning
start: 2027-06
dates: June 2027 · exact dates TBD (6-day draft)
...
> Draft plan. Anything marked {verify} (opening days, prices, transport) must be checked on the official website before booking.
...
- Plan rules: at most 2 big activities a day, a midday break away from the heat, and long drives kept to their own days.

## ✈️ Flights {#flights}
Fly into **Taoyuan International Airport (TPE)**. The Airport MRT express goes to Taipei Main Station in about 35–40 minutes {verify}. Some regional flights land at Songshan (TSA), which is in the city.

| Leg | Date | Flight | Depart → Arrive | Notes |
|-----|------|--------|-----------------|-------|
| Outbound | TBD | TBD | → TPE | Prefer a morning arrival |
| Return | TBD | TBD | TPE → | An afternoon/evening flight leaves time for Xpark |

## 🏨 Accommodation {#accommodation}
Base yourselves in central Taipei close to an MRT station. Good areas are around Taipei Main Station (for the Airport MRT), Zhongshan, or Xinyi. Book a family or triple room. Leofoo's on-site resort is worth considering for Day 4 night {verify}.
...
- [ ] Fix dates (check the Dragon Boat Festival holiday and avoid Mondays for the gondola)
- [ ] Flights to TPE
...
- [ ] Check entry requirements and arrival-card rules for our passports
...
| Leofoo tickets | TBD | |
| Car charter (Days 4–5) | TBD | |
| Other attractions (zoo, gondola, Xpark, farm) | TBD | |
| Food | TBD | |
| EasyCard top-ups / taxis | TBD | |

## ℹ️ Practical info {#practical}
- **Weather:** June is hot (often above 30 °C) and very humid, with afternoon thunderstorms. The plum-rain season is ending and typhoon season is starting, so keep the plan flexible.
- **Holiday:** The Dragon Boat Festival (端午節) falls around 9 June 2027 {verify}. Expect a long weekend with crowds and higher prices, but you can also watch the boat races.
- **Entry / visa:** This depends on your passports. Check the official rules, including whether an online arrival card is required {verify}.
- **Currency:** New Taiwan Dollar (TWD). Night markets and small shops often take cash only.
...
- Police: **110**
- Ambulance / fire: **119**
- Tourist information hotline: 0800-011-765 {verify}
- Nearest embassy / representative office: TBD (depends on passport)
...
- Compact umbrellas or light rain jackets, plus quick-dry clothes
- Sunscreen, hats, and a refillable water bottle each
- Hand sanitiser and wipes (for animal feeding)
- Mosquito repellent
- A light jacket for heavily air-conditioned MRT trains and malls
- Type A plug adapter if needed
